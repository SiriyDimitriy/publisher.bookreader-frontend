...
export default class CropImageUpload extends React.Component {
    constructor() {
        super();
        this.state = {
            imageDataUrl: null,
    ...
    render() {
        ...
        return (
            <Wrap>
                <SelectPhoto onClick={changeStateDialog} title='select file'>
                    <MediaIcon />
                </SelectPhoto>
                <Dialog
                    modal={false}
                    ...
                    <ModalContent>
                        ...
                        {imageDataUrl ? (
                            <div>
                                <ReactCrop
                                    src={imageDataUrl}
                                    crop={{width: 100, aspect: 2}}
                                    keepSelection={true}
                                    onComplete={this._handleChange}
                                    onImageLoaded={this._handleLoad}
                                />
                                <BtnsBlock>
                                    {loading ? (
                                        ...
                                        [
                                            <button onClick={this._handleSave} key='saveBtn'>
                                                save
                                            </button>,
                                            <RotateBtn
    ...
    _handleSave = () => {
        ...
        image.onload = () => {
            ...
            //   this.props.uploadPhoto(canvas.toDataURL());
